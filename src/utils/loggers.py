...
from src.sim.valuation import calculate_sum_rate, get_SINR
    ...
    def _on_step(self) -> bool:
        ...
        def on_episode_end():
            ...
            for nb in range(env.N_BS):
                ...
                total_rates = calculate_sum_rate(total_SINR[ue_idx, op, :])
                direct_rates = calculate_sum_rate(direct_SINR[ue_idx, op, :])
                total_sum_rates.append(total_rates)
                sum_rate_improvement.append(total_rates / direct_rates - 1.0)

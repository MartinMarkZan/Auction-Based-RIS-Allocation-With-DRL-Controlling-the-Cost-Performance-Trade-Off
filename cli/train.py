...
def make_vec_env(cfg: Config, render_mode: str | None = None):
    ...
    # Supersuit concatenate multiple environments (CPUs > 1 does not seem to work in Win).
...
if __name__ == "__main__":
    ...
    early_stop_callback = StopTrainingOnNoModelImprovement(max_no_improvement_evals=10, min_evals=30, verbose=1)
